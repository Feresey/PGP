build/common.cpp.o: common.cpp dim3/dim3.hpp grid/grid.hpp helpers.hpp problem.hpp solver.hpp
...
build/main.cpp.o: dim3/dim3.hpp grid/grid.hpp helpers.hpp main.cpp problem.hpp solver.hpp
build/problem.cpp.o: dim3/dim3.hpp grid/grid.hpp helpers.hpp problem.cpp problem.hpp
build/solver.cpp.o: dim3/dim3.hpp exchange.hpp grid/grid.hpp helpers.hpp problem.hpp solver.cpp solver.hpp
