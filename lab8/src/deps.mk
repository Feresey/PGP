...
build/pool__kernels.cpp.o: dim3/dim3.hpp grid/grid.hpp helpers.cuh helpers.hpp pool/kernels.cpp pool/kernels.hpp
build/pool__kernels.cu.o: dim3/dim3.hpp grid/grid.hpp helpers.cuh helpers.hpp myvector/vector.cuh pool/kernels.cu pool/kernels.hpp
