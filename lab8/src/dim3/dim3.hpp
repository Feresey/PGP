...
public:
    ...
    mydim3(int my, dim3_type type, int a, int b)
    {
        int index = 0;
    ...
    iterator<mydim3*> max_dim() { return std::max_element(begin(), end()); }
    iterator<const mydim3*, const T> max_dim() const { return std::max_element(cbegin(), cend()); }

    iterator<mydim3*> begin() { return iterator<mydim3*>(this); }
    iterator<mydim3*> end() { return iterator<mydim3*>(this, true); }

    iterator<const mydim3*, const T> cbegin() const { return iterator<const mydim3*, const T>(this); }
    iterator<const mydim3*, const T> cend() const { return iterator<const mydim3*, const T>(this, true); }
    iterator<const mydim3*, const T> begin() const { return iterator<const mydim3*, const T>(this); }
    iterator<const mydim3*, const T> end() const { return iterator<const mydim3*, const T>(this, true); }
};
